...
/*=============================================================
CONSULTAS ADICIONALES UTILIZADAS PARA EL DASHBOARD
=============================================================*/

-- 1. Métricas agregadas por fuente
...
FROM datos_para_dashboard
GROUP BY utm_source
ORDER BY ROI DESC;



-- 2. Métricas por fuente, medio y campaña
